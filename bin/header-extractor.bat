...
set "APP_CLASSPATH=%APP_LIB_DIR%\im.chic.devtools.header-extractor-0.1-SNAPSHOT.jar;%APP_LIB_DIR%\org.scala-lang.scala-library-2.10.5.jar;%APP_LIB_DIR%\com.github.scopt.scopt_2.10-3.3.0.jar;%APP_LIB_DIR%\com.google.guava.guava-18.0.jar"
...
"%_JAVACMD%" !_JAVA_OPTS! !HEADER_EXTRACTOR_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
